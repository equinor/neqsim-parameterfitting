    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (dataSet.next() && p < 80) {
                ...
                double[] parameterGuess = {4898.64, -111.76}; // , -0.1, -0.44}; //, 0.07};
                                                              // //propane
         ...
         * function.setInitialGuess(parameterGuess); sampleList.add(sample); } } catch(Exception
         * ex){ logger.error("database error", ex); }
         */
