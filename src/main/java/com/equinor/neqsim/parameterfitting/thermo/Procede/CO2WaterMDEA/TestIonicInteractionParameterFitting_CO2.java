package com.equinor.neqsim.parameterfitting.thermo.Procede.CO2WaterMDEA;
...
public class TestIonicInteractionParameterFitting_CO2 {
    ...
    public static void main(String[] args) {
        ...
        try (NeqSimDataBase database = new NeqSimDataBase();
                ResultSet dataSet =
                        database.getResultSet("SELECT * FROM CO2WaterMDEA WHERE ID<231")) {
            int i = 0;
            logger.info("adding....");
            while (dataSet.next()) {
                i++;
        ...
        try (NeqSimDataBase database = new NeqSimDataBase();
                ResultSet dataSet =
                        database.getResultSet("SELECT * FROM CO2WaterMDEA WHERE ID>230")) {
            int i = 0;
