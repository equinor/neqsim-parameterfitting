package com.equinor.neqsim.parameterfitting.thermo.Procede.WaterMDEA;
...
public class TestBinaryHVParameterFitting_MDEA {
    ...
    public static void main(String[] args) {
         ...
         * BinaryHVParameterFittingFunction_MDEA(); function.setInitialGuess(guess);
         * 
         ...
         * sample.setThermodynamicSystem(testSystem); sampleList.add(sample); } } catch(Exception
         * ex){ logger.info("database error", ex); }
         * 
         * 
