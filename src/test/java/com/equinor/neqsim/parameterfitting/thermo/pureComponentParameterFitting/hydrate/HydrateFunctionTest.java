package com.equinor.neqsim.parameterfitting.thermo.pureComponentParameterFitting.hydrate;
...
public class HydrateFunctionTest {
    static Logger logger = LogManager.getLogger(HydrateFunctionTest.class);
