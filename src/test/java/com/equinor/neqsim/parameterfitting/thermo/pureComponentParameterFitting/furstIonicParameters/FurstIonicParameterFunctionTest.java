package com.equinor.neqsim.parameterfitting.thermo.pureComponentParameterFitting.furstIonicParameters;
...
public class FurstIonicParameterFunctionTest {
    static Logger logger = LogManager.getLogger(FurstIonicParameterFunctionTest.class);
    ...
    public void main() {
        ...
        try (NeqSimDataBase database = new NeqSimDataBase();
                ResultSet dataSet = database
                        .getResultSet("SELECT * FROM saltdens WHERE ion1='Na+' AND ion2='Cl-'")) {
